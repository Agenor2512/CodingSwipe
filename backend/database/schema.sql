...
insert into
  resume_has_programming_languages (resume_id, programming_languages_id)
values
...
insert into
  experiences (candidate_id, job_title, company, experiences)
values
  (
    "2de1feec-a19a-4f16-9226-af782acdab42",
...
insert into
  job_offer_has_programming_languages (job_offer_id, programming_languages_id)
values
